          ...
          <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
            <div className="flex-1 text-center md:text-left">
              <div className="flex items-center justify-center md:justify-start gap-3 mb-4">
                ...
                <h1 className="font-montserrat font-bold text-2xl sm:text-3xl lg:text-4xl text-black dark:text-white">
                  {data.title}
                </h1>
              </div>
              <p
      ...
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 py-10 md:py-14">
        <div className="flex flex-col lg:flex-row gap-10 lg:gap-14">
          ...
          <div className="flex-1">
            <h2 className="font-montserrat font-bold text-xl sm:text-2xl text-black dark:text-white mb-6">
              Course Modules
            </h2>
              ...
              {data.modules.map((mod, i) => (
                <div
                  ...
                  className={`flex items-center justify-between p-4 sm:p-5 rounded-xl transition-all ${
                    mod.locked
                      ? 'bg-[#FAFAFA] dark:bg-[#1a1a1a] opacity-70'
                      : 'bg-[#F0FBF9] dark:bg-[#112220]'
                  }`}
                >
                  <div className="flex items-center gap-3 sm:gap-4 min-w-0">
                    <div
                      className="flex items-center justify-center rounded-full font-montserrat font-bold text-white flex-shrink-0 w-8 h-8 sm:w-9 sm:h-9 text-xs sm:text-sm"
                      style={{ backgroundColor: mod.locked ? '#CCC' : data.color }}
                    >
                      {i + 1}
                    </div>
                    <span className="font-montserrat font-bold text-sm sm:text-base text-black dark:text-white truncate">
                      {mod.title}
                    </span>
                  </div>
          ...
          <div className="lg:w-72 flex-shrink-0">
            <div className="p-6 rounded-2xl sticky top-[110px] bg-[#FAFAFA] dark:bg-[#1a1a1a]">
              <h3 className="font-montserrat font-bold text-lg text-black dark:text-white mb-5">
                Course Info
              </h3>
              <div className="space-y-4">
                <div className="flex justify-between">
                  <span className="font-montserrat text-sm text-[#666] dark:text-gray-400">
                    Modules
                  </span>
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-montserrat font-bold text-sm" style={{ color: data.color }}>
                    In Progress
                  </span>
                </div>
              </div>
              <button
                className="w-full font-montserrat font-bold text-white mt-6 h-11 rounded-lg text-sm hover:opacity-90 transition-all cursor-pointer"
