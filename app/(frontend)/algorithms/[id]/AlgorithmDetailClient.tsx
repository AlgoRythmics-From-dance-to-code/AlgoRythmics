        ...
        <div className="max-w-[1200px] mx-auto px-4 sm:px-6">
          ...
          <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
            ...
            <div className="flex-shrink-0 w-48 sm:w-56 md:w-64 lg:w-80">
              <Image src={`/assets/${data.illAsset}`} alt={data.name} width={330} height={330} className="w-full h-auto dark:invert dark:hue-rotate-180" style={{ width: 'auto', height: 'auto' }} />
            </div>
