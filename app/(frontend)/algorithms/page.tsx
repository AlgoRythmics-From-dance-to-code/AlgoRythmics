...
const sortingAlgorithms: AlgorithmCard[] = [
  {
    ...
    name: 'Bubble sort',
    description:
      'A form of sorting by exchanging that simply interchanges pairs of elements that are out of order in a sequence of passes through the file, until the list is sorted.',
    category: 'sorting',
  ...
  },
  {
    ...
    name: 'Shell sort',
    description:
      'A sorting algorithm proposed by Donald Shell in 1959, it is a variant of straight insertion sort that allows records to take long leaps rather than single steps.',
    category: 'sorting',
  ...
  },
  {
    ...
    name: 'Merge sort',
    description:
      'Merge sort is a divide-and-conquer algorithm that divides the array in half, sorts each half, and then merges them back together in the correct order.',
    category: 'sorting',
  ...
  },
  {
    ...
    name: 'Quick sort',
    description:
      'Quick sort selects a pivot element and partitions the array around it, placing smaller elements before and larger after the pivot, then recursively sorts both sides.',
    category: 'sorting',
  ...
  },
  {
    ...
    name: 'Heap sort',
    description:
      'Heap sort uses a binary heap data structure. It builds a max-heap from the array, then repeatedly extracts the maximum element to build the sorted array.',
    category: 'sorting',
...
const searchingAlgorithms: AlgorithmCard[] = [
  {
    ...
    name: 'Linear search',
    description:
      'A sequential search algorithm that checks each element of the array from the beginning, comparing each element with the desired value.',
    category: 'searching',
    illAsset: 'algo_group_109.svg',
  },
  {
    ...
    name: 'Binary search',
    description:
      'An efficient search algorithm that repeatedly divides the sorted search interval in half until the target value is found or the interval is empty.',
    category: 'searching',
    illAsset: 'algo_group_142.svg',
  },
];
...
const backtrackingAlgorithms: AlgorithmCard[] = [
  {
    ...
    description:
      'The N-Queens problem is a classic backtracking problem that involves placing N chess queens on an N×N chessboard so that no two queens threaten each other.',
