...
export default function LoginPage() {
  ...
  const validate = () => {
    ...
    else if (!/\S+@\S+\.\S+/.test(email)) newErrors.email = t('login.errors.email_invalid');
  ...
  return (
    <div className="w-full bg-white dark:bg-[#0a0a0a] min-h-[calc(100vh-85px)]">
      <div className="flex flex-col lg:flex-row min-h-[calc(100vh-85px)]">
        ...
        <div className="flex-1 flex flex-col items-center justify-center px-6 py-8 sm:px-10">
          <div className="w-full max-w-[500px]">
            ...
            <form onSubmit={handleSubmit}>
              {/* Email field */}
              <div className="mb-4">
                <label className="font-montserrat font-bold text-black dark:text-white block mb-2 text-sm select-none">
                  {t('login.email_label')}
                </label>
                <input
                  type="email"
                  ...
                  className={`w-full font-montserrat h-11 sm:h-12 border-2 border-[#E0E0E0] dark:border-neutral-700 bg-white dark:bg-[#2a2a2a] dark:text-white rounded-lg px-3 sm:px-4 text-base outline-none focus:border-[#36D6BA] transition-colors ${errors.email ? 'border-red-500' : ''}`}
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  className={`w-full font-montserrat h-11 sm:h-12 border-2 border-[#E0E0E0] dark:border-neutral-700 bg-white dark:bg-[#2a2a2a] dark:text-white rounded-lg px-3 sm:px-4 text-base outline-none focus:border-[#36D6BA] transition-colors ${errors.password ? 'border-red-500' : ''}`}
              ...
              <div className="flex items-center justify-between mb-8">
                <label className="flex items-center gap-2 cursor-pointer font-montserrat text-sm">
                  <input
                    ...
                    className="w-4 h-4 accent-[#36D6BA]"
                  />
            ...
            <div className="flex items-center gap-4 my-6">
              ...
              <span className="font-montserrat text-sm text-[#999] dark:text-gray-500">
                {t('login.or')}
              </span>
              <div className="flex-1 h-px bg-[#E0E0E0] dark:bg-neutral-700" />
            </div>
            ...
            <div className="grid grid-cols-2 gap-3 mb-6">
              <button
                ...
                className="flex items-center justify-center gap-2 font-montserrat font-medium h-11 sm:h-12 border-2 border-[#E0E0E0] dark:border-neutral-700 rounded-lg text-sm text-[#333] dark:text-white bg-white dark:bg-[#2a2a2a] cursor-pointer hover:bg-gray-50 dark:hover:bg-neutral-800 transition-all"
              >
              ...
              <button
                ...
                className="flex items-center justify-center gap-2 font-montserrat font-medium h-11 sm:h-12 border-2 border-[#E0E0E0] dark:border-neutral-700 rounded-lg text-sm text-[#333] dark:text-white bg-white dark:bg-[#2a2a2a] cursor-pointer hover:bg-gray-50 dark:hover:bg-neutral-800 transition-all col-span-1"
              >
