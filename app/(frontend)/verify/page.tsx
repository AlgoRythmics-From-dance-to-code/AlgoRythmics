      ...
      <div className="w-full max-w-md bg-white dark:bg-[#1a1a1a] rounded-2xl shadow-xl p-10 border border-gray-100 dark:border-neutral-800">
        {status === 'loading' && (
          <div className="flex flex-col items-center">
            ...
            <h1 className="text-2xl font-montserrat font-bold text-black dark:text-white mb-2">{t('verify.title_verifying')}</h1>
        ...
        {status === 'success' && (
          <div className="flex flex-col items-center animate-in fade-in zoom-in duration-500">
            ...
            <h1 className="text-2xl font-montserrat font-bold text-black dark:text-white mb-2">{t('verify.title_success')}</h1>
        ...
        {status === 'error' && (
          <div className="flex flex-col items-center animate-in fade-in zoom-in duration-500">
            ...
            <h1 className="text-2xl font-montserrat font-bold text-black dark:text-white mb-2">{t('verify.title_failed')}</h1>
            <p className="text-gray-600 dark:text-gray-400 font-montserrat mb-8 whitespace-pre-wrap">{message}</p>
            <Link
...
export default function VerifyPage() {
  ...
  return (
    <div className="min-h-[calc(100vh-140px)] bg-[#F0FBF9] dark:bg-[#0a0a0a] flex items-center justify-center font-montserrat">
      <Suspense fallback={<div className="font-montserrat text-black dark:text-white">{t('verify.loading')}...</div>}>
        <VerifyContent />
      </Suspense>
    </div>
  );
