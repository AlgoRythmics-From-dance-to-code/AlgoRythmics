    ...
    <div className="min-h-screen bg-white dark:bg-[#0a0a0a] pt-24 pb-20 px-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none font-montserrat text-gray-700 dark:text-gray-300 space-y-6">
          <section>
            <h2 className="text-2xl font-bold text-black dark:text-white mb-4">{t('privacy_page.gen_title')}</h2>
            <p>
              {t('privacy_page.gen_text')}
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-bold text-black dark:text-white mb-4">{t('privacy_page.data_title')}</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-black dark:text-white mb-4">{t('privacy_page.usage_title')}</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-black dark:text-white mb-4">{t('privacy_page.protection_title')}</h2>
            <p>
              {t('privacy_page.protection_text')}
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-bold text-black dark:text-white mb-4">{t('privacy_page.rights_title')}</h2>
            <p>
              {t('privacy_page.rights_text')}
            </p>
          </section>
        </div>
