  ...
  return (
    <div className="w-full bg-white dark:bg-[#0a0a0a]">
      ...
      <div className="flex flex-col items-center justify-center px-6 py-16 md:py-24 bg-[#F0FBF9] dark:bg-[#112220]">
        <h1 className="font-montserrat font-bold text-black dark:text-white text-3xl sm:text-4xl lg:text-[56px] mb-5 text-center">About Us</h1>
        <p className="font-montserrat text-center text-base sm:text-lg lg:text-xl max-w-3xl text-[#666] dark:text-gray-400" style={{ lineHeight: "1.8em" }}>
      ...
      <div className="max-w-[1200px] mx-auto px-6 py-16 md:py-20">
        <div className="flex flex-col md:flex-row items-center gap-10 md:gap-16">
          <div className="flex-1 text-center md:text-left">
            ...
            <p className="font-montserrat text-base sm:text-lg mb-5 text-[#333] dark:text-gray-300" style={{ lineHeight: "2em" }}>
            ...
            <p className="font-montserrat text-base sm:text-lg text-[#333] dark:text-gray-300" style={{ lineHeight: "2em" }}>
      ...
      <div className="px-6 py-12 md:py-20 bg-[#FAFAFA] dark:bg-[#1a1a1a]">
        <div className="max-w-[1200px] mx-auto">
          <h2 className="font-montserrat font-bold text-center text-2xl sm:text-3xl lg:text-4xl text-black dark:text-white mb-4">Our Team</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
            {teamMembers.map((member) => (
              <div key={member.name} className="flex flex-col items-center p-6 sm:p-8 bg-white dark:bg-[#2a2a2a] rounded-2xl shadow-sm transition-all hover:shadow-lg hover:-translate-y-1">
                ...
                <h3 className="font-montserrat font-bold text-center text-base sm:text-lg text-black dark:text-white mb-2">{member.name}</h3>
                <p className="font-montserrat text-center text-sm text-[#666] dark:text-gray-400">{member.role}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* How It Works */}
      <div className="max-w-[1200px] mx-auto px-6 py-16 md:py-20">
        <h2 className="font-montserrat font-bold text-center text-2xl sm:text-3xl lg:text-4xl text-black dark:text-white mb-12">How It Works</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {steps.map((step) => (
            <div key={step.number} className="flex flex-col items-center text-center">
              ...
              <p className="font-montserrat text-sm sm:text-base text-[#666] dark:text-gray-400" style={{ lineHeight: "1.8em" }}>
                {step.description}
              </p>
            </div>
          ))}
      ...
      <div className="flex flex-col items-center justify-center px-6 py-16 md:py-20 bg-[#269984] dark:bg-[#0a0a0a]">
        ...
        <a href="/register" className="font-montserrat font-bold text-white px-10 py-4 rounded-lg text-lg sm:text-xl hover:opacity-90 transition-all bg-[#36D6BA]"
