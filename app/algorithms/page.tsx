          ...
          <div key={algo.id}>
            ...
            <div className={`flex flex-col ${index % 2 === 0 ? "md:flex-row" : "md:flex-row-reverse"} items-center gap-8 md:gap-12`}>
              ...
              <div className="flex-1 text-center md:text-left">
                <h2 className="font-montserrat font-bold text-2xl sm:text-3xl lg:text-4xl mb-4" style={{ color: "#36D6BA" }}>
                  {algo.name}
                </h2>
                ...
                <Link
                  ...
                  className="inline-flex items-center justify-center font-montserrat font-bold transition-colors border-2 border-[#36D6BA] text-[#36D6BA] hover:bg-[#36D6BA] hover:text-white px-8 py-2.5 text-base sm:text-lg rounded-lg"
                >
                  Read more
                </Link>
              </div>
